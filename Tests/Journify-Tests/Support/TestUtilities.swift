...
class GooberPlugin: EventPlugin {
    ...
    func identify(event: IdentifyEvent) -> IdentifyEvent? {
        ...
        Journify.journifyMetric(.gauge, name: "Gauge Test", value: finalTime, tags: ["timing", "function_length"])
...
class BlockNetworkCalls: URLProtocol {
    ...
    override func startLoading() {
        client?.urlProtocol(self, didReceive: HTTPURLResponse(url: URL(string: "http://api.journify.com")!, statusCode: 200, httpVersion: nil, headerFields: ["blocked": "true"])!, cacheStoragePolicy: .notAllowed)
