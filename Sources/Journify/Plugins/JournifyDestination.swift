...
public class JournifyDestination: DestinationPlugin, Subscriber {
    internal enum Constants: String {
        case integrationName = "Journify.io"
    ...
    private let uploadsQueue = DispatchQueue(label: "uploadsQueue.journify.com")
...
extension JournifyDestination: VersionedPlugin {
